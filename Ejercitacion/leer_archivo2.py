#
# Listar el archivo de ventas, recorriendolo scuencialmente, separando cada uno
# de los datos que vinen en la línea e informando al final el total general de
